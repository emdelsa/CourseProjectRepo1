...
## Extracts only the measurements with mean() and std() suffixes for each measurement. 
## Uses descriptive activity names to name the activities in the data set
## Correct variable names so they do not contain "()" or "-". 
...
## Merge training and and test sets
